...
We have crept up on the solution, so it might be clear to you how few steps you
needed to do this task.  To show that more clearly, here is the whole solution
to the problem, without the comments:
