...
```{r, tbl-veh-numbers, eval=TRUE, echo=FALSE}
...
```{r, tbl-veh-numbers-counts, eval=TRUE, echo=FALSE}
...
sum(py$df_counts['#9'] >= 3)` rows with three or more in the last column.
Finally we divide this number of rows by the number of trials (`r py$n_trials`)
to get an estimate of the *proportion* of days with three or more breakdowns.
The result is `r sum(py$df_counts['#9'] >= 3) / py$n_trials`.
