...
fruit flies on the benchmark assumption — the "null hypothesis" — that each
fruit fly has an equal chance of being a male or female. Now we want to
discover the chances of getting more than 13 (i.e., 14 or more) males or more
than 13 females under these conditions. So we COUNT the number of males in
each random sample and then keep SCORE of this number for each sample.
...
```matlab
' Program file: "testing_counts_1_00.rss"
...
<!---
NB - I (MB) have not checked the Mosteller and Rourke reference.  Will do at
the end of June when I get a copy of the book.
-->
