...
@sec-fruitly used an observed sample of male and female fruitflies to test the
...
ketable(py$pill_trials,
        caption = "Results from 25 random trials for pill/placbo {#tbl-pill-trials}")
```
...
Now a {{< var lang >}} procedure to answer the question:
...
mean ranks between the two groups: (8/2 - 7/3 =) 1.6.)
...
statistically significant difference in densities between the further planets
