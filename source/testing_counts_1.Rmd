...
`r n_25_gte_14` result.

@tbl-fruitfly-trials shows the results obtained in twenty-five trials of twenty
flips each. In `r int2tw(n_25_gte_14)` of the twenty-five trials
(`r round(n_25_gte_14 / n * 100)` percent) there were fourteen or more tails,
which we call "males," and in `r int2tw(n_25_lte_6)` of the twenty-five trials
(`r round(n_25_lte_6 / n * 100)` percent) there six or fewer tails, meaning
there were fourteen or more heads ("females"). We can therefore estimate that,
even if the treatment does *not* affect the sex and the births over a long
period really are one to one, `r int2tw(n_25_both)` out of twenty-five times
