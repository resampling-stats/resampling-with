...
210, while for marksman D the mean score is (10\*1) + (60\*2) + (30\*3) = 220.
Hence we can say that D is better than C even though D's score does not
...
matches (which turns out be 1\*.07 + 2\*0.16 + 3\* 0.55 + 4\*0.21 + 5\*0.01 =
2.93 ) in the observed experience by 20. Here you are using the mean as an
indication of a representative case.
