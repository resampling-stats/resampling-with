...
$$
P(\text{car_broken | mechanic_approved}) = P(\text{car_broken and mechanic_approved}) / P(\text{mechanic_approved})
$$
...
analytic method (see e.g. Box and Tiao, Appendix A1.1) make it almost
