...
A long time ago this writer developed a signature verification system with some of his students. The system wasn't
perfect; it sometimes got it wrong. It would sometimes classify a genuine signature as a forgery and at other times a
forgery as a genuine signature. Then we asked the question, if our system classified a signature as a forgery, what
were the chances that it actually was a forgery?

This is an important question because if the system is wrong too many times, i.e. it too often makes the mistake of
saying that a genuine signature is a forgery then the customers providing the signatures will get really annoyed and
the institution using our system will be mightily upset.

We did the calculations and decided, wisely, not to try and sell the  system - it made too many mistakes.

This chapter is all about answering questions like this one. The fundamental tool is Bayes' theorem. Before we
introduce it, we'll answer questions like these, al always, through simulation.
