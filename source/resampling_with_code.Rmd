...
*with replacement*, using the `replace=TRUE` instruction.  We will explain more
about what sampling *with replacement*  means soon, but until then, *with
replacement* gives us the same effect as rolling the 10-sided dice.
