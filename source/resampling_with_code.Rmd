...
treatment for Burkitt lymphoma.  [Burkitt
lymphoma](https://en.wikipedia.org/wiki/Burkitt_lymphoma) is a rather unusual
cancer of the lymphatic system — a vein-like network throughout the body that
is involved in the immune reaction to disease. In developed countries, with
standard treatment, the cure rate for Burkitt lymphoma is about 90%.  The
National Cancer Institute's gave their new treatment to 17 patients, and found
that all 17 patients were "cured" — meaning that the disease had not
progressed in any of the 17 patients, in more than two years of follow-up.

Here is where we put on our statistical hat.  Now we are wearing that hat, we
wonder whether the 100% could be due to random variation.

How could it happen by chance, that 17 out of 17 patients were cured?

We know that the average cure rate in the developed world is 90%.  That means,
that each patient that we treat has a 90% chance of being cured.  Let's say we
treat one patient with some new treatment, and they are cured.   Is the
treatment better or worse than the standard treatment?   We don't really know,
because there is a 90% chance they would be cured, if the treatment is just
the same as the standard treatment, and so it is more likely than not that
they will be cured, even if the treatment as about the same as the standard
treatment.
...
::: python
To put chance into our model, we will be asking the computer to generate many
random numbers.  So, before we start, we again import NumPy and get its
