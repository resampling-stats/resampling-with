...
```{python, opts.label="py_ed"}
# Make a sequence of numbers, store with the name "some_numbers".
...
We can ask {{< var lang >}} to show us the result inside the notebook, by executing a {{< var cell >}} that contains the variable name on its own on a line:
