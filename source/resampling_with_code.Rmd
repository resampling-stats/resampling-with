...
Think of `round` as the name of a process, that takes in a *component* (in this case, any number), and does some work, and sends back the finished *result* (in this case, the number rounded to the nearest integer.
...
In fact, we often need to do what we have done above, and generate a
sequence or *range* of integers, such as 0 through 9.
...
syntax]{.r}[standard function]{.python} to do that.
