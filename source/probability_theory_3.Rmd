...
discussed in @sec-prob-theory-one-b. In Example 7-4, a bullseye, an in-the-white
...
**4a.** Repeat steps 2a and 3a perhaps 10000 times and compute the
proportion "Yes."
...
**4b.** As above, repeat steps 2a and 3a perhaps 10000 times and compute
the proportion "Yes."
...
inches, 20 percent; 2.2 inches, 30 percent; 2.3 inches, 20 percent; 2.4
inches, 10 percent.

If you draw a handle and a head at random, what will be the mean total
length? In @sec-prob-theory-one-b we saw that the conventional formulaic method tells
...
**Step 3.** Repeat step 2 perhaps 400 or 10000 times, and calculate the
...
coin 200 times. Finally, note how the REPEAT 10000 loop simulates 10000 games,
...
```{r drunk-walk, echo=FALSE, fig.align="center", fig.cap="Drunk random walk"}
...
@sec-finite-universes when discussing probability in finite universes, and then at
great length in the context of statistics in @sec-testing-measured. This example
...
@sec-testing-procedures generalizes what we have done in the probability problems
