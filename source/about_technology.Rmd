...
When you press {{< var run_key >}}, {{< var lang >}} makes its own
representation of `10.50`, and its own representation of `9.25`, and then runs
the *addition* operation on these two, which results in Python's
representation of `19.75`.

Finally, {{< var lang >}} sends back the `19.75`.  The notebook detects that
{{< var lang >}} sent back a value, and shows it to us.
