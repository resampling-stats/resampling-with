...
# And Some Last Words About the Reliability of Sample Averages {#sec-reliability-average}
...
```{r fig-pop_prop_disp, echo=FALSE, fig.align='center', fig.cap="Relationship Between the Population Proportion and the Likely Error In a Sample"}
include_svg('images/pop_prop_disp.svg')
```
...
of point estimation is discussed in @sec-point-estimation.
