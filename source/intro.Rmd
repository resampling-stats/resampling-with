...
3. *You are the manager and part owner* of one of several contractors
   ...
   in ten. You want to know the chance on a particular day --- tomorrow ---
   that three or more of them will be out of action.
...
2. *You are an environmental scientist* monitoring levels of phosphorus
   ...
   reaching the lake, or is this just some random fluctuation in the
...
different words for the same idea --- that some event will or will not happen,
or that something is true or false. To put it another way, we want to answer
...
2. *Should you advise the Republicrat presidential candidate to go to New
   Hampshire* to campaign? If the poll tells you conclusively that he or she
   ...
   conclusively that he or she surely will win in New Hampshire, you probably
...
4. *Should we invest in a search for new causes of phosphorus pollution* as a
   ...
   random variability, we will have invested time and money in a search where
   it could better have been spent elsewhere.
