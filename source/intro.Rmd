...
solve for us. One reason that the term "statistic" often scares and confuses people is that the term has several sorts of meanings.  We discuss the various meanings of "statistics" in the section "Types of statistics".
Then comes a discussion on the relationship of probabilities to decisions.
Following this we talk about the limitations of probability and statistics.
And last is a discussion of why statistics can be such a difficult subject.
Most important, this chapter describes the types of problems the book will
tackle.
...
2. *You are an environmental scientist* monitoring levels of phosphorus
   ...
   reaching the lake, or could this be the result of fluctuation in the
...
A statistic is a *number* or set of numbers that we can calculate from a
larger collection of numbers we are interested in.  A statistic can be
*descriptive* or *inferential*.  A descriptive statistic is a number (or set
of numbers) that aim to describe the larger set of number. Some common
examples are the *total*, measures of the center of a distribution such as the
*mean* and *median*, and numbers conveying the spread of the distribution such
as the *range*, and the *standard deviation*.
