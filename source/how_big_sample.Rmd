...
described in @sec-contract-poll. The table shows that if half the people (or
more) are against the contract, only one in twenty times will thirty-two
(or more) people of a sample of fifty say that they are for the contract;
that is, only one of twenty trials with a 50-50 universe will produce as many
as thirty-two *yeses* if a majority of the population is against it.
