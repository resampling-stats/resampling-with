...
values (say, whether or not there has been irradiation.)[^see-simon]
...
```{r fig-hypot_iq_athletic_1, echo=FALSE, fig.align='center', fig.cap="Hypothetical Scores for I.Q. and Athletic Ability — 1"}
include_svg('images/hypot_iq_athletic_1.svg')
```


```{r fig-hypot_iq_athletic_2, echo=FALSE, fig.align='center', fig.cap="Hypothetical Scores for I.Q. and Athletic Ability — 2"}
include_svg('images/hypot_iq_athletic_2.svg')
```
...
```{r fig-given_iq_athletic, echo=FALSE, fig.align='center', fig.cap="Given Scores for I.Q. and Athletic Ability"}
include_svg('images/given_iq_athletic.svg')
```
...
some of the high level carries over from one year into the next.[^example]
...
[^example]: Example from [@wallis1956statistics, pages 565 -- 556].
