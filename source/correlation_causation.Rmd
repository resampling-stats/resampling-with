...
IQ score and the IQ-100 score, the association has not changed, even though the
mean product is much smaller.
...
some number.  In summary, the mean product depends on the *scale* or *units* of
...
### Exercise: runs, strikeouts, correlation coefficient {#sec-exr-runs-strikeout-r}
