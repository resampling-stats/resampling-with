...
relationship between pairs of values.  For example we found that the sum of products for the athletic and IQ scores was `r sop_aiq`.  The sum of products is useful because it allows us to compare the strength of relationship between different pairings — if the sum of products is higher for another ordering of the data, it means that the other ordering corresponds to a better match in order between the values in the pairs.
