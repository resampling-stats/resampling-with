...
5 I.Q. rankings (out of 10). We COUNT how many are in the top 5, and keep track
of the result. After repeating 10,000 times using a `for` loop, we find out how
often we select 4 of the top 5.
