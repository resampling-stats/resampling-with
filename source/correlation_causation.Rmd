...
::: {.notebook name="consistent_drink" title="Does opinion match behavior in
a poll?"}

::: nb-only
Our aim is to work out the number of matching `drink` and `sale` 1, 0 scores in
the null-world, where the association between the two is random.
:::
