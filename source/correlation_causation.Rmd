...
```{r label='fig-ath-iq-scatter', fig.cap='Scatter plot of I.Q. Score as a function of Athletic Score', echo=FALSE, eval=TRUE}
plot(._df_ath_iq$athletic_score, ._df_ath_iq$iq_score,
     xlab='Athletic Score',
     ylab='I.Q. Score',
     main='I.Q. Score (y-axis) as a function of Athletic Score (x-axis)',
     frame.plot=FALSE)
axis(side=1)
```
