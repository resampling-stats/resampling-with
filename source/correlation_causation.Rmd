...
From a casual inspection of the Athletic scores and the IQ scores it appears as if there is indeed a correlation or
...
about gravity and things like that, the comment bothered me. Apart from the fact that it probably reflected a specific
philosophical view of the nature of science, I was hard-fetched to find an adequate response.
...
We need to move beyond being a computer that consumes the dat we are given, to being human, to take charge. 
...
Now things are about to change (for us, the ideas have been around for quite a while!). First of all we need to make a
distinction about *association* and *causality*. If we talk about the association, better perhaps, *correlation* in general
(not linear) terms, between variables, we are not allowed to infer any *causal* relationship between the variables.
