...
get a range of numbers from Python's `range` function.  `range` is a common and
useful alternative way to provide a range of numbers to a `for` loop.
...
almost as easily, write `for value in np.range(10000):` to do the same task.
