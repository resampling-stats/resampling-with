...
taster [@fisher1960design, Chapter II, section 5]. And one could adduce the
example of prices in different state liquor control systems (see TKTK) which
is similar to cases (3) and (4) except that sampling without replacement seems
appropriate. Again, the analogs to cases (2) and (4) would generally be called
"resampling."
