...
Probability is difficult to define [@feller1991introduction], but let us start
...
an uncertain situation — that is, when you lack information and therefore can
only make an estimate. For example, if someone asks you your name, you do not
use the concept of probability to answer; you know the answer to a very high
degree of surety. To be sure, there is some chance that you do not know your
own name, but for all practical purposes you can be quite sure of the answer.
If someone asks you who will win tomorrow's ball game, however, there is a
...
We have said that a probability statement is about the future. Well,
...
crew turn the valve in planned mission.
...
experience.  But again, note — the objectivity of the frequency series may be
more apparent than real — does a particular frequency series really apply?
Were the previous series of patients similar?  Has some treatment or lifestyle
change rendered the older data obsolete?  These decisions too are often a
matter of judgment.
...
probability — frequency and belief. Each is useful in some situations but not
...
guesses how likely it is that he will run out of stock if he orders 200 smart
...
then all his past experience summed into his intuition is a proxy for the
...
The point here is that the final sum of the dice *appears* to be random, in
the sense of unpredictable, but it becomes not-random — predictable — once the
magician knows the sum of the shown faces, along with the fact that the
opposite sides add to seven.
...
Now consider getting *random* numbers from the computer, where the numbers can either be 0 or 1.  This is rather like tossing a coin, where the results are 0 and 1 rather than "heads" and "tails".
...
distinguish them from random numbers, because we cannot do anything to predict
them.  The technical term for the computer random numbers is therefore
*pseudo-random* — meaning, random enough to be effectively unpredictable.

The computer uses lots of tricks to give us these pseudo-random numbers. The
numbers are random, in the sense that there is no *practical* way for you, or
even a very powerful computer, to do anything to improve the prediction for
...
that could make a big difference in a gambling game (Bulmer, 1979, p. 18).
