...
from bucket A".  If this condition is met — it is True that you have drawn a
blue ball from bucket A *then* we go on to do the stuff that is indented.
...
[^conditional-true]: In this case, the result of the conditional expression is
    ...
    as something "truthy" — that is - something that comes back as {{< var true
    >}} or {{< var false >}} from the [`logical`]{.r}[`bool`]{.python}
...
made by substituting 55 blue and 45 yellow balls in Step 4 — a similar
