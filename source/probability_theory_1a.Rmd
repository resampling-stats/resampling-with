...
day *and* the Commanders winning; and the birth of nine females out of the
...
of the Commanders winning Sunday arises from our lack of understanding of the
...
2.  The probabilities of all the possible alternative outcomes in a
    ...
    **Definition:** If there are just two events a and b and they are
    ...
    Let's return now to the Commanders. We said earlier that our best guess
    of the probability that the Commanders will win the first game is .6.
    Let's complicate the matter a bit and say that the probability of
    the Commanders winning depends upon the weather; on a nice day we
    ...
    Now, what about the estimate that the Commanders have a .65 chance of
    ...
    *construct* an estimate using whatever information or "hunch" we
    ...
    = .455 (Probability of nice day *and* Commanders win)

    Commanders lose (P = .35)

    Commanders win (P = .55)

    Commanders lose (P = .45)
...
= .65, and it is read "The probability that the Commanders will win if (given
...
if the Commanders win, there is a .3 chance you will leave the game early.
