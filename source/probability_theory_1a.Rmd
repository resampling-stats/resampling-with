...
(from Gardner, 1983, p. 42). "Shuffle a packet of four cards — two red, two
black — and deal them face down in a row. Two cards are picked at random, say
by placing a penny on each. What is the probability that those two cards are
the same color?"
...
card? Clearly, it is 50-50, or 0.5. Now, if you first pick a black card,
...
black card if the first one you pick is black? It is still 0.5 because we
