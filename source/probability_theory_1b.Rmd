...
# Probability Theory Part I (continued) {#sec-prob-theory-one-b}
...
Assume that we want to know the probability of four successful archery shots in
a row, where the probability of a success on a given shot is .25.
...
```{r fig-basketball-shots, echo=FALSE, fig.align='center', fig.cap="Tree Diagram for 3 Basketball Shots, Probability of a Hit is 1/3"}
include_svg('images/basketball_shots.svg')
```
