...
Simon gives the early history of this book in original preface
...
His first conclusion was that introductory courses in statistics use far too
much mathematics. Most students cannot follow that
mathematics, and they quickly get lost, reducing the subject to  "mumbo-jumbo"
(\@ref(brief-history)).

On its own, this was not a new conclusion.  Simon quotes a classic textbook by
...
Stats* language — of which more later.
...
good for you! -- and, please, read this book. There is a good chance that it
...
statistics down to its deepest foundations, but you will have the tools to
think of your own tests, for your own problems, and build those tests
yourself.
