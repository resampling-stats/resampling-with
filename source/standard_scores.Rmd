...
same procedure.  These are *ascending* ranks; the ranks are from high to low, meaning 1 is the highest median income, and 441 is the lowest median income.
...
While we are at it, let us also get the values from the "Rank" column, with the
same procedure.  These are ranks from high to low, meaning 1 is the highest
median income, and 441 is the lowest median income.
