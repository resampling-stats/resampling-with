...
print('25% rank:', hi_to_lo_ranks[110])
...
Let's have a look at the first 10 values:
...
What then, is the quantile value for a QP = 0.01?   There are various ways to answer that question, but one obvious way, and the default for Numpy / R, is to draw a straight line up from the matching rank --- or equivalently, down from the QP --- then note where that line crosses the lines joining the points on the graph above, and look across to the y-axis for the corresponding value:
