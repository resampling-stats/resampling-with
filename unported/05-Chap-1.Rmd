...
Computers and programming gives us a much faster way of solving problems with resampling.
...
We can show the value of of the variable `a` in the notebook or terminal by using the `print` function:
